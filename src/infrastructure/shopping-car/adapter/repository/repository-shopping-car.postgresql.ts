...
export class RepositoryShoppingCarPostgresql implements RepositoryShoppingCar {
  ...
  async saveShoppingCar(shoppingCar: ShoppingCar, queryRunner: QueryRunner): Promise<InsertResult> {
    return await this.entityManager.createQueryBuilder(queryRunner)
      .insert()
